 ...
 * @augments Driver
 */
class Zeroxexchange extends Driver {
  constructor() {
    super({
      requires: {
        key: true,
  ...
  async fetchTickers(isMocked) {
    ...
    const exchangeName = 'Zerox Exchange';

    if (isMocked) {
      now = '2022-11-21T06:31:43.484Z';
      twentyFourHoursAgo = '2022-11-20T06:31:43.484Z';
    }
