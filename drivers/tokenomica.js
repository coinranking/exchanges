 ...
 * @augments Driver
 */
class Tokenomica extends Driver {
  /**
   * @augments Driver.fetchTickers
   * @returns {Promise.Array<Ticker>} Returns a promise of an array with tickers.
   */
  async fetchTickers() {
    const { data: markets } = await request('https://api.wavesplatform.com/v0/pairs?limit=1000&matcher=3PJjwFREg8F9V6Cp9fnUuEwRts6HQQa5nfP');
    const { data: assets } = await request('https://api.wavesplatform.com/v0/assets?ticker=*&matcher=3PJjwFREg8F9V6Cp9fnUuEwRts6HQQa5nfP');
